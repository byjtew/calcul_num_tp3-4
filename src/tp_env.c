...
{
    printf(
        "--------- Test environment of execution for Practical exercises of "
    ...
    printf("The maximum double precision value from float.h is dbl_max = %e \n",
           DBL_MAX);
    printf(
        "The epsilon in single precision value from float.h is flt_epsilon = "
        "%e \n",
        FLT_EPSILON);
    printf(
        "The epsilon in double precision value from float.h is dbl_epsilon = "
        "%e \n",
        DBL_EPSILON);
